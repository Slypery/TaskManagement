...
@endsection
@section('main')
    <form id="FormAdd" action="{{ route('employee.submissions.store') }}" method="post" enctype="multipart/form-data" class="block w-full max-w-[1000px]">
        @csrf
        <input type="hidden" name="employee_task_id" value="{{ $task_origin->id }}">
