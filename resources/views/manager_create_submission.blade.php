...
@endsection
@section('main')
    <form id="FormAdd" action="{{ route('manager.submissions.store') }}" method="post" enctype="multipart/form-data" class="block w-full max-w-[1000px]">
        @csrf
        ...
        <h1 class="text-3xl font-semibold mb-2">Make Submission</h1>
        <x-horizontal-input id="AddTitle" name="title" placeholder="Title" type="text" label="Title" labelSpan="2" />
